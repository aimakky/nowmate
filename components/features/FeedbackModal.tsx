      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-5 shadow-xl" onClick={e => e.stopPropagation()}>
        {sent ? (
          <div className="text-center py-6">
            ...
            <p className="text-xs text-gray-400 mt-1">Your feedback helps us improve VILLIA for everyone.</p>
          </div>
        ) : (
          <>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <div className="text-xs text-gray-400 mt-0.5">What would make VILLIA better?</div>
              </div>
