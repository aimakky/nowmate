  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-5 py-8 prose prose-sm text-gray-700">
        ...
        <p>You must be 18 years of age or older to use nowjp. By creating an account, you confirm that you meet this requirement.</p>
        ...
        <p>nowjp is provided "as is". We are not responsible for the actions of users. Please exercise caution when meeting people from the platform in person.</p>
