...
export const alt = '休憩村 — Just landed? We\'ve got you.'
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ color: 'white', fontWeight: 900, fontSize: 48, letterSpacing: -2 }}>休憩村</span>
        </div>
        ...
        <div style={{
          ...
          Making friends in Japan is hard. 休憩村 makes it easy.
        </div>
