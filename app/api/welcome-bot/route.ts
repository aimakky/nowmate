...
const WELCOME_MESSAGES = [
  {
    emoji: '👋',
    content: "Welcome to nowjp! I'm your Japan setup guide. Your first mission: register 住民票 at your local city hall within 14 days of arrival. Need help? Head to the Survive tab →",
  },
  {
    emoji: '🏦',
