...
export const metadata: Metadata = {
  title: 'Language Exchange in Japan — Find a Partner & Actually Learn | nowmate',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        ...
        url="https://nowmatejapan.com/guides/language-exchange-japan"
      />
      ...
      <section className="bg-purple-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">
          nowmate matches you with Japanese speakers in your city who want to practice your language in exchange for Japanese.
        </p>
        <Link href="/signup"
