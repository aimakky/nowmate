...
export const metadata: Metadata = {
  title: 'New to Japan — Survival Guide for Foreigners | VILLIA',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        ...
        url="https://VILLIAjapan.com/guides/new-to-japan"
      />
      ...
      <div className="mx-5 mb-8 bg-brand-500 rounded-2xl p-4 text-center">
        ...
        <p className="text-blue-100 text-xs mb-3">Find friends at the same stage as you on VILLIA</p>
      ...
      <section className="bg-blue-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">Join VILLIA free. Match with other new arrivals and locals who get it.</p>
