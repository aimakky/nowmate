...
export const metadata: Metadata = {
  title: 'Moving to Japan Checklist 2026 — Complete Guide for Foreigners | nowjp',
...
const FIRST_MONTH = [
  ...
  { task: 'Connect with other expats in your city', note: 'Use nowjp — find people at your exact arrival stage.' },
]
