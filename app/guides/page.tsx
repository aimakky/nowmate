...
export const metadata: Metadata = {
  title: 'Japan Expat Guides — Survival, Friends & City Life | 自由村',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <section className="bg-brand-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">Guides are great. Real friends are better. Join 自由村 free.</p>
