...
export const metadata: Metadata = {
  title: 'Expats in Osaka — Making Friends & Community Guide | Samee',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        ...
        description="Osaka is Japan's most welcoming city for foreigners. Here's how to make the most of it."
        url="https://sameejapan.com/guides/expats-in-osaka"
      />
      ...
      <div className="mx-5 mb-8 bg-orange-500 rounded-2xl p-4 text-center">
        ...
        <p className="text-orange-100 text-xs mb-3">Meet expats and locals in Osaka on Samee</p>
      ...
      <section className="bg-orange-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">Join Samee free and connect with expats and locals in Osaka.</p>
