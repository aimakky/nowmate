...
export const metadata: Metadata = {
  title: 'First Week in Japan — Foreigner\'s Survival Guide 2026 | nowjp',
...
const DAYS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Find expats in your area', note: 'You\'re not the first foreigner to figure this out. Connect with people who\'ve done it — ask on nowjp.' },
  ...
  return (
    <div className="min-h-screen bg-white max-w-2xl mx-auto px-5 py-8">
      ...
      <div className="bg-brand-50 border border-brand-100 rounded-3xl p-6 text-center">
        ...
        <p className="text-sm text-gray-500 mb-4">Post a help request on nowjp — people who've been through your exact situation are ready to help. Free, fast, and real.</p>
        <Link href="/signup"
