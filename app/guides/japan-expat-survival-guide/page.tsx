...
export const metadata: Metadata = {
  title: 'Japan Expat Survival Guide 2026 — Everything You Need to Know | 休憩村',
...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      { q: 'Best ways to learn Japanese in Japan?', a: 'Language exchange partners (HelloTalk, 休憩村\'s language exchange feature), community centers offer cheap Japanese classes, JLPT study groups on Meetup. Immersion works — set your phone to Japanese.' },
    ],
  },
  {
    emoji: '👥',
    ...
    content: [
      ...
      { q: 'Where do expats actually make friends?', a: 'Language exchanges, international community events, sports clubs (futsal, running, volleyball leagues welcome foreigners), shared housing, and expat apps like 休憩村. The expat community in Japan is larger and more welcoming than it appears from the outside.' },
  ...
  return (
    <div className="min-h-screen bg-white max-w-2xl mx-auto px-5 py-8">
      ...
      <div className="bg-brand-50 border border-brand-100 rounded-3xl p-6 text-center mt-10">
        ...
        <p className="text-sm text-gray-500 mb-4">Join 休憩村 and connect with foreigners who've navigated everything in this guide — and are ready to help you do the same.</p>
        <Link href="/signup"
