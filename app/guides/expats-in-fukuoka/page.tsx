...
export const metadata: Metadata = {
  title: 'Expats in Fukuoka — Small City, Big Community | VILLIA',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        ...
        url="https://VILLIAjapan.com/guides/expats-in-fukuoka"
      />
      ...
      <section className="bg-green-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">Join VILLIA free. Find your Fukuoka crew.</p>
