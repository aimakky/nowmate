...
export const metadata: Metadata = {
  title: 'Making Friends in Japan as a Foreigner — The Honest Guide | Samee',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        ...
        url="https://sameejapan.com/guides/making-friends-in-japan"
      />
      ...
      <div className="mx-5 mb-8 bg-brand-500 rounded-2xl p-4 text-center">
        ...
        <p className="text-blue-100 text-xs mb-3">Find friends at your arrival stage on Samee</p>
      ...
      <section className="bg-rose-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">Samee matches you with expats and locals in Japan. Free, no weird vibes.</p>
