...
export const metadata: Metadata = {
  title: 'Expats in Tokyo — Making Friends & Building Your Life | 休憩村',
  ...
  openGraph: {
    ...
    description: 'Making friends in Tokyo as a foreigner. What nobody tells you, and how 休憩村 helps.',
  },
}
...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `Tokyo is the best city in Japan for language exchange. Japanese people learning English — or other languages — are everywhere, and many are actively looking for conversation partners.\n\nApp-based options like 休憩村 match you with Japanese speakers who want to practice your language in exchange for Japanese. This creates a natural, low-pressure way to build real friendships rather than transactional language swaps.`,
  },
  {
    emoji: '🏠',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      <ArticleJsonLd
        title="Expats in Tokyo — The Real Survival Guide"
        description="Making friends in Tokyo as a foreigner. What nobody tells you, and how 休憩村 helps."
        url="https://休憩村japan.com/guides/expats-in-tokyo"
      />
      ...
      <div className="mx-5 mb-8 bg-brand-500 rounded-2xl p-4 text-center">
        ...
        <p className="text-brand-100 text-xs mb-3">Meet expats and locals near you on 休憩村</p>
        <Link href="/signup"
      ...
      <section className="bg-gray-50 mx-5 rounded-3xl p-6 mb-10 text-center">
        ...
        <p className="text-gray-500 text-sm mb-5 leading-relaxed">
          Join 休憩村 free. Find expats and locals who get what it's like to be new in Japan.
        </p>
        <Link href="/signup"
