...
export const metadata: Metadata = {
  title: 'nowjp for Business — Improve Expat Employee Retention in Japan',
  description: 'Help your international employees build real connections in Japan. nowjp reduces expat isolation, improves wellbeing, and lowers turnover. Partner with us.',
  openGraph: {
    title: 'nowjp for Business — Expat Employee Retention in Japan',
    description: 'Foreign employees who build social networks in Japan stay longer. nowjp helps them get there.',
  },
}
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <section className="px-5 pt-8 pb-10 text-center">
        ...
        <a href="mailto:business@nowjpjapan.com"
      ...
      <section className="px-5 py-10">
        <h2 className="text-xl font-extrabold text-center text-gray-800 mb-2">How nowjp helps</h2>
      ...
      <section className="bg-brand-500 px-5 py-10 text-center">
        ...
        <p className="text-brand-100 text-sm mb-6 leading-relaxed">
          We'll show you how nowjp works and build a custom plan for your organization.
        </p>
        <a href="mailto:business@nowjpjapan.com"
      ...
      <footer className="border-t border-gray-100 px-5 py-6 text-center bg-white">
        ...
        <p className="text-xs text-gray-400 mb-3">nowjp Japan · business@nowjpjapan.com</p>
